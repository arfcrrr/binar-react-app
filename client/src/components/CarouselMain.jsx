...
import { ReactComponent as ButtonLeft } from '../assets/images/left_button.svg';
import { ReactComponent as ButtonRight } from '../assets/images/right_button.svg';
...
class CarouselMain extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            nextIcon: <span className="me-5"><ButtonRight /></span>,
            prevIcon: <span className="ms-5"><ButtonLeft /></span>
        }
    }
